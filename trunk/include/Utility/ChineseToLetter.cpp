...
namespace game_client
{
	...
	std::string FindPyLetter(int nCode);

	stdex::tString GetPyLetter(const stdex::tString &srcText)
	{
		std::string dst;
		std::string src(CT2A(srcText.c_str()));
		for(size_t idx = 0; idx != src.length(); ++idx)
		{
			...
			else
			{
				...
				{
					std::string py = FindPyLetter((ch - 0xa0) * 100 + ch2 - 0xa0);
					dst += py[0];
				}
				++idx;
			}
		...
		stdex::ToLower(dst);
		return stdex::tString((LPCTSTR)CA2T(dst.c_str()));
	}
    ...
    const MulPyInfo C_MUL_PY_LIST[] = 
    {
        {L'½µ', TEXT("jx")},
        {L'°¢', TEXT("ae")},	{L'ÞÖ', TEXT("an")},	{L'°Ç', TEXT("bp")},	{L'±¤', TEXT("bp")},
        {L'±©', TEXT("bp")},	{L'±Ù', TEXT("bp")},	{L'±â', TEXT("bp")},	{L'²Ø', TEXT("cz")},
        {L'ìø', TEXT("cs")},	{L'²ü', TEXT("cz")},	{L'³¯', TEXT("cz")},	{L'³µ', TEXT("cj")},
        {L'³Î', TEXT("cd")},	{L'³×', TEXT("cs")},	{L'³ô', TEXT("cx")},	{L'Ðó', TEXT("cx")},
        {L'èÈ', TEXT("cz")},	{L'ÔÜ', TEXT("cz")},	{L'´é', TEXT("cz")},	{L'µ¥', TEXT("ds")},
        {L'Ìá', TEXT("dt")},	{L'¶Ú', TEXT("dt")},	{L'¸ï', TEXT("gj")},	{L'ºÏ', TEXT("gh")},
        {L'¸ø', TEXT("gj")},	{L'¹È', TEXT("gy")},	{L'èí', TEXT("gh")},	{L'Ïï', TEXT("hx")},
        {L'»á', TEXT("hk")},	{L'¾±', TEXT("jg")},	{L'èÛ', TEXT("jg")},	{L'Ææ', TEXT("jq")},
        {L'ÇÑ', TEXT("jq")},	{L'½Ä', TEXT("jy")},	{L'½Ë', TEXT("jc")},	{L'Ð£', TEXT("jx")},
        {L'½â', TEXT("jx")},	{L'½æ', TEXT("jg")},	{L'ñæ', TEXT("jq")},	{L'¿¨', TEXT("kq")},
        {L'¿Ç', TEXT("kq")},	{L'Âû', TEXT("mw")},	{L'ÃØ', TEXT("mb")},	{L'ÃÚ', TEXT("mb")},
        {L'ÅÙ', TEXT("pb")},	{L'ÆÙ', TEXT("pb")},	{L'ÆÜ', TEXT("qx")},	{L'õè', TEXT("qx")},
        {L'»ü', TEXT("qj")},	{L'ôò', TEXT("qj")},	{L'ÏÃ', TEXT("sx")},	{L'Ê¶', TEXT("sz")},
        {L'µ÷', TEXT("td")},	{L'Î²', TEXT("wx")},	{L'Î¾', TEXT("wy")},	{L'ÏÅ', TEXT("xh")},
        {L'ÏË', TEXT("xq")},	{L'ÐÐ', TEXT("xh")},	{L'Ê¡', TEXT("xs")},	{L'ËÞ', TEXT("xs")},
        {L'Óõ', TEXT("yx")},	{L'Ôþ', TEXT("zy")},	{L'Õ³', TEXT("zn")},	{L'Êô', TEXT("zs")},
        {L'´±', TEXT("zc")},	{L'´«', TEXT("cz")},    {L'ÖØ', TEXT("cz")}
    };
    std::pair<stdex::tString, stdex::tString> GetMulPy(const stdex::tString& src)
    {
        static std::map<TCHAR, const WCHAR*> multiChar;
        if (multiChar.size() == 0)
        {
            int nMultiCharCount = _countof(C_MUL_PY_LIST);
            for (int i = 0; i < nMultiCharCount; ++i)
            {
                multiChar.insert(std::make_pair(C_MUL_PY_LIST[i].chChar, C_MUL_PY_LIST[i].szPy));
            }
        }
        std::pair<stdex::tString, stdex::tString> py;
        py.first = GetPyLetter(src);
        UINT nNameLen = src.size(), nIndex = 0;
        std::map<TCHAR, const WCHAR*>::iterator it = multiChar.end();
        for (nIndex = 0; nIndex < nNameLen; ++nIndex)
        {
            it = multiChar.find(src[nIndex]);
            if (it != multiChar.end()) 
                break;
        }
        if (it != multiChar.end())
        {
            py.second = py.first;
            py.first[nIndex] = it->second[0];
            py.second[nIndex] = it->second[1];
        }
        return py;
    }
}